...
public class Check implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5806634970537770323L;
	private Grid grid;
	...
	public void checkResult(int count, String player) {
		...
		if (count == total) {
			print(String.format("%s%s wins!\n\nGame Over!", this.grid.displayGrid(),player));
			finish = true;
		}//end of if statement
	...
	//We need to change finish to true as well here, as game is finished.
	...
	//Helpful print method including JOptionPane displaying message
